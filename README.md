...
Both boards include USB-C, UART, SWD, a local $12 \mathrm{MHz}$ crystal, and a $10 \mathrm{MHz}$ SiTime SiT5346 DCTCXO reference. The SiT5346 is connected to the RP2354A through a GPIO/PIO clock input and is controllable over the existing $\text{I²C}$ bus. Each board also exposes a dedicated $1\mathrm{PPS}$ output generated by the RP2354A. The initial target is a stable free-space optical link over approximately $5$ meters.
